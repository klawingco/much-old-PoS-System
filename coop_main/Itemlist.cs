    ...
    public partial class Itemlist : Form
    {
        ...
        private void populateItemList() {
            try
            {
                ...
                dbhandler.getAllProducts(dataGridView1);
            }
            catch (Exception xx)
            {
        ...
        private void Itemlist_Shown(object sender, EventArgs e)
        {
            populateItemList();
        }
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            if (txt_search.Text.Trim() != "Type Keyword to Search" || txt_search.Text.Trim() == "")
            {
                ...
                try {
                    ...
                    dbhandler.getSearchProducts(dataGridView1, txt_search.Text.Trim().Replace("'", "`"));
                }
                catch(Exception) {
                    message mes = new message("ERROR: Cannot connect to the server\n Pls. Check your network connection");
                    mes.ShowDialog(mes.Parent);
