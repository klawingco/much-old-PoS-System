...
namespace coop_main
{
    ...
    {
        String empID;
        public transaction(String empID)
        {
            InitializeComponent();
            this.empID = empID;
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                voidlogin vlog = new voidlogin();
               DialogResult res = vlog.ShowDialog();
                if(res == System.Windows.Forms.DialogResult.OK && vlog.okay){
                    refunds f1 = new refunds(vlog.voidingempID);
                    f1.Show();
                    this.Close();
                }
