...
namespace coop_main
{
    public partial class Form1 : Form
    {
        ...
        {
            lbl_username.Text = Properties.Settings.Default.username.ToUpper();
           // if (empID == "" || empID == "0")
           // {
        ...
        {
            if (Globals.arrayModule[0] == "1")
            {
                members_form f1 = new members_form();
                f1.Show();
                this.Close();
            }
            else {
        ...
        {
            if (Globals.arrayModule[10] == "1")
            {
                Form2 fr = new Form2(empID);
                fr.Show();
                this.Close();
            }
            else
        ...
        {
            if (Globals.arrayModule[18] == "1")
            {
                Form4 f4 = new Form4(empID);
                f4.Show();
                this.Close();
            }
            else
        ...
        {
            /*Form3 f3 = new Form3(empID);
            f3.Show();*/
            if (Globals.arrayModule[24] == "1")
            {
                ReportsForm re = new ReportsForm(empID);
                re.Show();
                this.Close();
            }
            else
        ...
        {
            if (Globals.arrayModule[3] == "1")
            {
                transaction f1 = new transaction(empID);
                f1.Show();
                this.Close();
            }
            else
        ...
        {
            if (Globals.arrayModule[34] == "1")
            {
                miscellaneous f1 = new miscellaneous(empID);
                f1.Show();
                this.Close();
            }
            else
        ...
        {
            var a = DateTime.Now;
            label3.Text = "Today is "+ a.ToString("MM-dd-yyyy") + " "+ a.ToLongTimeString();
        }
