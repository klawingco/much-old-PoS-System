...
namespace coop_main
{
    public partial class end_of_the_day : Form
    {
        String empID;
        DatabaseStuff dbhandler = new DatabaseStuff();

        DataTable t;
        public end_of_the_day(String empID)
        {
            InitializeComponent();
            this.empID = empID;
        }
           ...
           DialogResult res=  f1.ShowDialog();
            if(res == System.Windows.Forms.DialogResult.OK){
                ...
                try
                {
                    ...
                    s.FileName = "End of the day for " + DateTime.Now.ToLongDateString() + ".xls";
        ...
        private void btn_ePDF_Click(object sender, EventArgs e)
        {
           ...
           DialogResult res =  f1.ShowDialog();
            if(res == System.Windows.Forms.DialogResult.Yes){
                ...
                OpenFileDialog ds = new OpenFileDialog();
                SaveFileDialog s = new SaveFileDialog();
                s.FileName = "End of the day for " + DateTime.Now.ToLongDateString()+".pdf";
        ...
        private void populateprintEndday()
        {
            ...
            reportViewer1.LocalReport.ReportPath = @"ReportMiscEndDay.rdlc";
        ...
        private void end_of_the_day_Shown(object sender, EventArgs e)
        {
            dbhandler.getEndOfDay(dataGridView1, dateTimePicker1.Value);
            double todaySale = 0;
            double voidTot = 0;
            int items = 0;
            try
        ...
        {
            end_of_the_week wee = new end_of_the_week(empID);
            wee.Show();
            this.Close();
        ...
        private void dateTimePicker1_ValueChanged(object sender, EventArgs e)
        {
          ...
          //  txt_weekRatio.Text = (dataGridView1.Rows.Count -1) .ToString() + " items";
